...
global function getCustomLoadout
...
string function getCustomLoadout() {

	string customAbility
	customAbility = GetConVarString( "password" )
	string newLoadout

	if (customAbility == "grapple") {
		newLoadout = "mp_ability_grapple"
	}
	else if (customAbility == "stim") {
		newLoadout = "mp_ability_heal"
	}
	else {
		newLoadout = "mp_ability_cloak"
	}
	return newLoadout
}
...
PilotLoadoutDef function GetPilotLoadoutForCurrentMapSP()
{
	...
	pilotLoadout.special = getCustomLoadout()
